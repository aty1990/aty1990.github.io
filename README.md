### 基本信息
 * 姓名：艾铁元　　　　　　 &nbsp;&nbsp;&nbsp;手机：13548952869
 * 性别：男　　　　　　　　　年龄：28（1991年）
 * 学校：湖南广播电视大学　　专业：计算机科学与技术
 * 工作年限：6年　　　　　　  &nbsp;邮箱：893466820@qq.com
...
###  2018年8月 - 至今  上海星共科技有限公司（合资） 　前端负责人

* 负责上海通用汽车公司下ibuick app应用嵌入的h5网页模块开发
* 负责项目框架的初始化和业务代码开发

* 公司网址 http://www.xglory.cn/

###  2017年7月 - 2018年7月  上海柏阔科技有限公司（合资） 　前端负责人
...
### 上海星共科技有限公司
   * 项目：ibuick 别克汇app模块开发
   * 对ibuick的新能源模块进行开发，改模块主要是用于线上销售汽车，目前只支持线上下单，后期可能会增加线上支付和零配件的一些捆绑销售
   * 项目是基于vue开发
   * 项目难点->汽车图片的加载速度和360度车辆的交互处理
   * 对全屏图片做手机系统的单独适配
   
   
   * 项目：中台管理系统(https://apigatewayqa.sgmlink.com:3301/middlems/#/admin/login)
   * 主要用于提供数据到app端呈现，处理一些商品的信息和用户的管理等操作，技术实现基于we-vue框架库

### 上海柏阔科技有限公司
   
 * 主要负责内嵌h5活动，注册，以及其他一些功能介绍页开发，h5购车商城模块的开发，对接外部app应用的实现，重点完成h5手机端选车，购车等整体流程的开发
以及整个项目结构和资源优化等一系列前端复杂的逻辑业务处理，对项目进行模块化开发与管理。基本vue技术栈，列举项目中遇到觉得比较棘手的一些问题：
  - 手机适配
  - 对接不同渠道处理的逻辑
  - 页面动画效果
  - 级联页面过多数据同步更新问题
...
* 字体，样式手机兼容性问题
* 打包体积，资源优化
* 解决问题的思路->通过官方文档，博客园等对技术进行深入的理解，也通过阅读源码去弄明白实现原理，尽可能多的去看一些组件化的代码，和浏览器特性的问题
